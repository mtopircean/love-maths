...
function displaySubtractQuestion(operand1, operand2) {
    // is operand 1 bigger then 2, if so, return 1, else, return 2
    document.getElementById('operand1').textContent = operand1 > operand2 ? operand1 : operand2;
    // carefull at operand 2 as this needs to be the second 2, so you have to make sure it is returned second
